...
label var   pondera         "Weighting factor at the individual level (expands to people)"
label var 	pondera_hh		"Weighting factor at the household level (expands to households)"
...
label var  	im_propina 		"Received income in your job/business for tips last month?"
label var  	im_comision 	"Received income in your job/business for commissions last month?"
label var  	im_ticket 		"Received income in your job/business for ticket basket, food card last month?"
label var  	im_guarderia 	"Received income in your job/business for childcare contribution last month?"
label var  	im_beca 		"Received income in your job/business for study grant last month?"
label var  	im_hijos 		"Received income in your job/business for child premium last month?"
label var  	im_antiguedad 	"Received income in your job/business for antiquity last month?"
label var  	im_transporte 	"Received income in your job/business for transportation voucher last month?"
label var  	im_rendimiento 	"Received income in your job/business for performance bonus last month?"
label var  	im_otro 		"Received income in your job/business for other bonuses and compensation last month?"
label var 	im_petro		"Received income in your job/business for Petros last month?"

label var  	c_sso  	"Contributions from your employer to social security for compulsory social security?"
label var  	c_rpv  	"Contributions from your employer to social security for housing and habitat benefits scheme?"
label var  	c_spf  	"Contributions from your employer to social security for forced unemployment insurance?"
label var  	c_aca  	"Contributions from your employer to social security for contribution from the savings bank?"
label var  	c_sps  	"Contributions from your employer to social security for contributions to the private insurance system?"
label var  	c_otro 	"Contributions from your employer to social security for other contributions?"
...
label var  	inm_productos  	"Received this benefit in your work last month?: company products"
label var  	inm_transporte  "Received this benefit in your work last month?: transportation"
label var  	inm_vehiculo  	"Received this benefit in your work last month?: vehicle for private use"
label var  	inm_estaciona  	"Received this benefit in your work last month?: parking fee exemption"
label var  	inm_telefono 	"Received this benefit in your work last month?: personal phone"
label var  	inm_servicios  	"Received this benefit in your work last month?: basic housing services"
label var  	inm_guarderia  	"Received this benefit in your work last month?: daycare from work"
...
label var  	im_indep  	"Received money or net benefits derived from your business or activity in last 12 months?"
...
label var inla_pens_soi "Survivor's pension, orphanhood, disability"
label var inla_pens_vss "Old-age pension by social security"
label var inla_jubi_emp "Work retirement"
label var inla_pens_dsa "Pension for divorce, separation, food"
label var inla_beca_pub "Public scholarship or school aid"
label var inla_beca_pri "Private scholarship or school aid"
label var inla_ayuda_pu "Help from public institutions"
label var inla_ayuda_pr "Help from private institutions"
label var inla_ayuda_fa "Help from family or contributions from other households"
label var inla_asig_men "Family allowance for dependent children"
label var inla_otros "Other Non Labor Income" 
label var inla_petro "Petro"

label var  iext_sueldo "Wages or salaries (abroad)"
label var  iext_ingnet "Net income of independent workers (abroad)"
label var  iext_indemn "Compensation for illness or accident (abroad)"
label var  iext_remesa "Remittances or periodic aid from other households (abroad)"
label var  iext_penjub "Pension & retirement (abroad)"
label var  iext_intdiv "Interest & dividends (abroad)"
label var  iext_becaes "Scholarships and / or school aid (abroad)"
label var  iext_extrao "Extraordinary transfers (compensation for insurance, inheritance, help from other households)(abroad)"
label var  iext_alquil "Rentals (vehicles, land or land, residential property or not)? (abroad)"
 ...
 *--------- How did the houselhold cope with the most recent shock
 /* (s15q2c): 2c. Cómo se las arregló su hogar con el choque más reciente?*/
	...
	label var reaccion_evento_1_1 "2c. Home sold livestock due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_2_1 "2c. Home sold land due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_3_1 "2c. Home sold property due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_4_1 "2c. Home sent children to live with friends due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_5_1 "2c. Home stopped sending children to school due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_6_1 "2c. Home worked in other income generating activities due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_8_1 "2c. Home received assistance from friends/relatives due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_9_1 "2c. Home received loans from friends/relatives due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_10_1 "2c. Home took loans from financial institutions due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_12_1 "2c. Home had members who emigrated for work due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_13_1 "2c. Home did credit purchases due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_14_1 "2c. Home delayed payment obligations due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_15_1 "2c. Home sold harvest in advance due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_16_1 "2c. Home reduced the consumption of food due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_17_1 "2c. Home reduced the consumption of non-food due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_18_1 "2c. Home used savings due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_19_1 "2c. Home received assistance from NGO due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_20_1 "2c. Home took payments in advance from employer due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_21_1 "2c. Home received assistance from the government due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_22_1 "2c. Home was covered by an insurance due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_23_1 "2c. Home did nothing due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_24_1 "2c. Home did other things due to the recent shock  1.Death or disability of an adult household member who works"
	label var reaccion_evento_1_2 "2c. Home sold livestock due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_2_2 "2c. Home sold land due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_3_2 "2c. Home sold property due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_4_2 "2c. Home sent children to live with friends due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_5_2 "2c. Home stopped sending children to school due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_6_2 "2c. Home worked in other income generating activities due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_8_2 "2c. Home received assistance from friends/relatives due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_9_2 "2c. Home received loans from friends/relatives due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_10_2 "2c. Home took loans from financial institutions due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_12_2 "2c. Home had members who emigrated for work due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_13_2 "2c. Home did credit purchases due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_14_2 "2c. Home delayed payment obligations due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_15_2 "2c. Home sold harvest in advance due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_16_2 "2c. Home reduced the consumption of food due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_17_2 "2c. Home reduced the consumption of non-food due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_18_2 "2c. Home used savings due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_19_2 "2c. Home received assistance from NGO due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_20_2 "2c. Home took payments in advance from employer due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_21_2 "2c. Home received assistance from the government due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_22_2 "2c. Home was covered by an insurance due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_23_2 "2c. Home did nothing due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_24_2 "2c. Home did other things due to the recent shock  2.Death of someone who sends remittances home"
	label var reaccion_evento_1_3 "2c. Home sold livestock due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_2_3 "2c. Home sold land due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_3_3 "2c. Home sold property due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_4_3 "2c. Home sent children to live with friends due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_5_3 "2c. Home stopped sending children to school due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_6_3 "2c. Home worked in other income generating activities due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_8_3 "2c. Home received assistance from friends/relatives due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_9_3 "2c. Home received loans from friends/relatives due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_10_3 "2c. Home took loans from financial institutions due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_12_3 "2c. Home had members who emigrated for work due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_13_3 "2c. Home did credit purchases due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_14_3 "2c. Home delayed payment obligations due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_15_3 "2c. Home sold harvest in advance due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_16_3 "2c. Home reduced the consumption of food due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_17_3 "2c. Home reduced the consumption of non-food due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_18_3 "2c. Home used savings due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_19_3 "2c. Home received assistance from NGO due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_20_3 "2c. Home took payments in advance from employer due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_21_3 "2c. Home received assistance from the government due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_22_3 "2c. Home was covered by an insurance due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_23_3 "2c. Home did nothing due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_24_3 "2c. Home did other things due to the recent shock  3.Illness of the person with the highest income in the household"
	label var reaccion_evento_1_4 "2c. Home sold livestock due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_2_4 "2c. Home sold land due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_3_4 "2c. Home sold property due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_4_4 "2c. Home sent children to live with friends due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_5_4 "2c. Home stopped sending children to school due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_6_4 "2c. Home worked in other income generating activities due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_8_4 "2c. Home received assistance from friends/relatives due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_9_4 "2c. Home received loans from friends/relatives due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_10_4 "2c. Home took loans from financial institutions due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_12_4 "2c. Home had members who emigrated for work due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_13_4 "2c. Home did credit purchases due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_14_4 "2c. Home delayed payment obligations due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_15_4 "2c. Home sold harvest in advance due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_16_4 "2c. Home reduced the consumption of food due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_17_4 "2c. Home reduced the consumption of non-food due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_18_4 "2c. Home used savings due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_19_4 "2c. Home received assistance from NGO due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_20_4 "2c. Home took payments in advance from employer due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_21_4 "2c. Home received assistance from the government due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_22_4 "2c. Home was covered by an insurance due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_23_4 "2c. Home did nothing due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_24_4 "2c. Home did other things due to the recent shock  4.Loss of major contact"
	label var reaccion_evento_1_5 "2c. Home sold livestock due to the recent shock  5.Job loss"
	label var reaccion_evento_2_5 "2c. Home sold land due to the recent shock  5.Job loss"
	label var reaccion_evento_3_5 "2c. Home sold property due to the recent shock  5.Job loss"
	label var reaccion_evento_4_5 "2c. Home sent children to live with friends due to the recent shock  5.Job loss"
	label var reaccion_evento_5_5 "2c. Home stopped sending children to school due to the recent shock  5.Job loss"
	label var reaccion_evento_6_5 "2c. Home worked in other income generating activities due to the recent shock  5.Job loss"
	label var reaccion_evento_8_5 "2c. Home received assistance from friends/relatives due to the recent shock  5.Job loss"
	label var reaccion_evento_9_5 "2c. Home received loans from friends/relatives due to the recent shock  5.Job loss"
	label var reaccion_evento_10_5 "2c. Home took loans from financial institutions due to the recent shock  5.Job loss"
	label var reaccion_evento_12_5 "2c. Home had members who emigrated for work due to the recent shock  5.Job loss"
	label var reaccion_evento_13_5 "2c. Home did credit purchases due to the recent shock  5.Job loss"
	label var reaccion_evento_14_5 "2c. Home delayed payment obligations due to the recent shock  5.Job loss"
	label var reaccion_evento_15_5 "2c. Home sold harvest in advance due to the recent shock  5.Job loss"
	label var reaccion_evento_16_5 "2c. Home reduced the consumption of food due to the recent shock  5.Job loss"
	label var reaccion_evento_17_5 "2c. Home reduced the consumption of non-food due to the recent shock  5.Job loss"
	label var reaccion_evento_18_5 "2c. Home used savings due to the recent shock  5.Job loss"
	label var reaccion_evento_19_5 "2c. Home received assistance from NGO due to the recent shock  5.Job loss"
	label var reaccion_evento_20_5 "2c. Home took payments in advance from employer due to the recent shock  5.Job loss"
	label var reaccion_evento_21_5 "2c. Home received assistance from the government due to the recent shock  5.Job loss"
	label var reaccion_evento_22_5 "2c. Home was covered by an insurance due to the recent shock  5.Job loss"
	label var reaccion_evento_23_5 "2c. Home did nothing due to the recent shock  5.Job loss"
	label var reaccion_evento_24_5 "2c. Home did other things due to the recent shock  5.Job loss"
	label var reaccion_evento_1_6 "2c. Home sold livestock due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_2_6 "2c. Home sold land due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_3_6 "2c. Home sold property due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_4_6 "2c. Home sent children to live with friends due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_5_6 "2c. Home stopped sending children to school due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_6_6 "2c. Home worked in other income generating activities due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_8_6 "2c. Home received assistance from friends/relatives due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_9_6 "2c. Home received loans from friends/relatives due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_10_6 "2c. Home took loans from financial institutions due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_12_6 "2c. Home had members who emigrated for work due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_13_6 "2c. Home did credit purchases due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_14_6 "2c. Home delayed payment obligations due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_15_6 "2c. Home sold harvest in advance due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_16_6 "2c. Home reduced the consumption of food due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_17_6 "2c. Home reduced the consumption of non-food due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_18_6 "2c. Home used savings due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_19_6 "2c. Home received assistance from NGO due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_20_6 "2c. Home took payments in advance from employer due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_21_6 "2c. Home received assistance from the government due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_22_6 "2c. Home was covered by an insurance due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_23_6 "2c. Home did nothing due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_24_6 "2c. Home did other things due to the recent shock  6.Exit of family member generating income due to separation or divorce"
	label var reaccion_evento_1_7 "2c. Home sold livestock due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_2_7 "2c. Home sold land due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_3_7 "2c. Home sold property due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_4_7 "2c. Home sent children to live with friends due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_5_7 "2c. Home stopped sending children to school due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_6_7 "2c. Home worked in other income generating activities due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_8_7 "2c. Home received assistance from friends/relatives due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_9_7 "2c. Home received loans from friends/relatives due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_10_7 "2c. Home took loans from financial institutions due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_12_7 "2c. Home had members who emigrated for work due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_13_7 "2c. Home did credit purchases due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_14_7 "2c. Home delayed payment obligations due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_15_7 "2c. Home sold harvest in advance due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_16_7 "2c. Home reduced the consumption of food due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_17_7 "2c. Home reduced the consumption of non-food due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_18_7 "2c. Home used savings due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_19_7 "2c. Home received assistance from NGO due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_20_7 "2c. Home took payments in advance from employer due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_21_7 "2c. Home received assistance from the government due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_22_7 "2c. Home was covered by an insurance due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_23_7 "2c. Home did nothing due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_24_7 "2c. Home did other things due to the recent shock  7.Exit of family member generating income due to marriage"
	label var reaccion_evento_1_8 "2c. Home sold livestock due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_2_8 "2c. Home sold land due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_3_8 "2c. Home sold property due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_4_8 "2c. Home sent children to live with friends due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_5_8 "2c. Home stopped sending children to school due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_6_8 "2c. Home worked in other income generating activities due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_8_8 "2c. Home received assistance from friends/relatives due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_9_8 "2c. Home received loans from friends/relatives due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_10_8 "2c. Home took loans from financial institutions due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_12_8 "2c. Home had members who emigrated for work due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_13_8 "2c. Home did credit purchases due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_14_8 "2c. Home delayed payment obligations due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_15_8 "2c. Home sold harvest in advance due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_16_8 "2c. Home reduced the consumption of food due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_17_8 "2c. Home reduced the consumption of non-food due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_18_8 "2c. Home used savings due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_19_8 "2c. Home received assistance from NGO due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_20_8 "2c. Home took payments in advance from employer due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_21_8 "2c. Home received assistance from the government due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_22_8 "2c. Home was covered by an insurance due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_23_8 "2c. Home did nothing due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_24_8 "2c. Home did other things due to the recent shock  8.Non-farm business failure"
	label var reaccion_evento_1_9 "2c. Home sold livestock due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_2_9 "2c. Home sold land due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_3_9 "2c. Home sold property due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_4_9 "2c. Home sent children to live with friends due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_5_9 "2c. Home stopped sending children to school due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_6_9 "2c. Home worked in other income generating activities due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_8_9 "2c. Home received assistance from friends/relatives due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_9_9 "2c. Home received loans from friends/relatives due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_10_9 "2c. Home took loans from financial institutions due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_12_9 "2c. Home had members who emigrated for work due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_13_9 "2c. Home did credit purchases due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_14_9 "2c. Home delayed payment obligations due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_15_9 "2c. Home sold harvest in advance due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_16_9 "2c. Home reduced the consumption of food due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_17_9 "2c. Home reduced the consumption of non-food due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_18_9 "2c. Home used savings due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_19_9 "2c. Home received assistance from NGO due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_20_9 "2c. Home took payments in advance from employer due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_21_9 "2c. Home received assistance from the government due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_22_9 "2c. Home was covered by an insurance due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_23_9 "2c. Home did nothing due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_24_9 "2c. Home did other things due to the recent shock  9.Theft of crops, cash, livestock or other goods"
	label var reaccion_evento_1_10 "2c. Home sold livestock due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_2_10 "2c. Home sold land due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_3_10 "2c. Home sold property due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_4_10 "2c. Home sent children to live with friends due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_5_10 "2c. Home stopped sending children to school due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_6_10 "2c. Home worked in other income generating activities due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_8_10 "2c. Home received assistance from friends/relatives due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_9_10 "2c. Home received loans from friends/relatives due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_10_10 "2c. Home took loans from financial institutions due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_12_10 "2c. Home had members who emigrated for work due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_13_10 "2c. Home did credit purchases due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_14_10 "2c. Home delayed payment obligations due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_15_10 "2c. Home sold harvest in advance due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_16_10 "2c. Home reduced the consumption of food due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_17_10 "2c. Home reduced the consumption of non-food due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_18_10 "2c. Home used savings due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_19_10 "2c. Home received assistance from NGO due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_20_10 "2c. Home took payments in advance from employer due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_21_10 "2c. Home received assistance from the government due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_22_10 "2c. Home was covered by an insurance due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_23_10 "2c. Home did nothing due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_24_10 "2c. Home did other things due to the recent shock  10.Crop destruction by fire"
	label var reaccion_evento_1_11 "2c. Home sold livestock due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_2_11 "2c. Home sold land due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_3_11 "2c. Home sold property due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_4_11 "2c. Home sent children to live with friends due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_5_11 "2c. Home stopped sending children to school due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_6_11 "2c. Home worked in other income generating activities due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_8_11 "2c. Home received assistance from friends/relatives due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_9_11 "2c. Home received loans from friends/relatives due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_10_11 "2c. Home took loans from financial institutions due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_12_11 "2c. Home had members who emigrated for work due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_13_11 "2c. Home did credit purchases due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_14_11 "2c. Home delayed payment obligations due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_15_11 "2c. Home sold harvest in advance due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_16_11 "2c. Home reduced the consumption of food due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_17_11 "2c. Home reduced the consumption of non-food due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_18_11 "2c. Home used savings due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_19_11 "2c. Home received assistance from NGO due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_20_11 "2c. Home took payments in advance from employer due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_21_11 "2c. Home received assistance from the government due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_22_11 "2c. Home was covered by an insurance due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_23_11 "2c. Home did nothing due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_24_11 "2c. Home did other things due to the recent shock  11.Damaged / demolished home"
	label var reaccion_evento_1_12 "2c. Home sold livestock due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_2_12 "2c. Home sold land due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_3_12 "2c. Home sold property due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_4_12 "2c. Home sent children to live with friends due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_5_12 "2c. Home stopped sending children to school due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_6_12 "2c. Home worked in other income generating activities due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_8_12 "2c. Home received assistance from friends/relatives due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_9_12 "2c. Home received loans from friends/relatives due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_10_12 "2c. Home took loans from financial institutions due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_12_12 "2c. Home had members who emigrated for work due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_13_12 "2c. Home did credit purchases due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_14_12 "2c. Home delayed payment obligations due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_15_12 "2c. Home sold harvest in advance due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_16_12 "2c. Home reduced the consumption of food due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_17_12 "2c. Home reduced the consumption of non-food due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_18_12 "2c. Home used savings due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_19_12 "2c. Home received assistance from NGO due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_20_12 "2c. Home took payments in advance from employer due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_21_12 "2c. Home received assistance from the government due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_22_12 "2c. Home was covered by an insurance due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_23_12 "2c. Home did nothing due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_24_12 "2c. Home did other things due to the recent shock  12.Few rains that caused the failure of the harvest"
	label var reaccion_evento_1_13 "2c. Home sold livestock due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_2_13 "2c. Home sold land due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_3_13 "2c. Home sold property due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_4_13 "2c. Home sent children to live with friends due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_5_13 "2c. Home stopped sending children to school due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_6_13 "2c. Home worked in other income generating activities due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_8_13 "2c. Home received assistance from friends/relatives due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_9_13 "2c. Home received loans from friends/relatives due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_10_13 "2c. Home took loans from financial institutions due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_12_13 "2c. Home had members who emigrated for work due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_13_13 "2c. Home did credit purchases due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_14_13 "2c. Home delayed payment obligations due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_15_13 "2c. Home sold harvest in advance due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_16_13 "2c. Home reduced the consumption of food due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_17_13 "2c. Home reduced the consumption of non-food due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_18_13 "2c. Home used savings due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_19_13 "2c. Home received assistance from NGO due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_20_13 "2c. Home took payments in advance from employer due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_21_13 "2c. Home received assistance from the government due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_22_13 "2c. Home was covered by an insurance due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_23_13 "2c. Home did nothing due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_24_13 "2c. Home did other things due to the recent shock  13.Floods that caused the failure of the harvest"
	label var reaccion_evento_1_14 "2c. Home sold livestock due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_2_14 "2c. Home sold land due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_3_14 "2c. Home sold property due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_4_14 "2c. Home sent children to live with friends due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_5_14 "2c. Home stopped sending children to school due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_6_14 "2c. Home worked in other income generating activities due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_8_14 "2c. Home received assistance from friends/relatives due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_9_14 "2c. Home received loans from friends/relatives due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_10_14 "2c. Home took loans from financial institutions due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_12_14 "2c. Home had members who emigrated for work due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_13_14 "2c. Home did credit purchases due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_14_14 "2c. Home delayed payment obligations due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_15_14 "2c. Home sold harvest in advance due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_16_14 "2c. Home reduced the consumption of food due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_17_14 "2c. Home reduced the consumption of non-food due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_18_14 "2c. Home used savings due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_19_14 "2c. Home received assistance from NGO due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_20_14 "2c. Home took payments in advance from employer due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_21_14 "2c. Home received assistance from the government due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_22_14 "2c. Home was covered by an insurance due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_23_14 "2c. Home did nothing due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_24_14 "2c. Home did other things due to the recent shock  14.Invasion of pests that caused crop failure or loss of storage"
	label var reaccion_evento_1_15 "2c. Home sold livestock due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_2_15 "2c. Home sold land due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_3_15 "2c. Home sold property due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_4_15 "2c. Home sent children to live with friends due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_5_15 "2c. Home stopped sending children to school due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_6_15 "2c. Home worked in other income generating activities due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_8_15 "2c. Home received assistance from friends/relatives due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_9_15 "2c. Home received loans from friends/relatives due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_10_15 "2c. Home took loans from financial institutions due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_12_15 "2c. Home had members who emigrated for work due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_13_15 "2c. Home did credit purchases due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_14_15 "2c. Home delayed payment obligations due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_15_15 "2c. Home sold harvest in advance due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_16_15 "2c. Home reduced the consumption of food due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_17_15 "2c. Home reduced the consumption of non-food due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_18_15 "2c. Home used savings due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_19_15 "2c. Home received assistance from NGO due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_20_15 "2c. Home took payments in advance from employer due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_21_15 "2c. Home received assistance from the government due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_22_15 "2c. Home was covered by an insurance due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_23_15 "2c. Home did nothing due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_24_15 "2c. Home did other things due to the recent shock  15.Loss of property due to fire or flood"
	label var reaccion_evento_1_16 "2c. Home sold livestock due to the recent shock  16.Loss of land"
	label var reaccion_evento_2_16 "2c. Home sold land due to the recent shock  16.Loss of land"
	label var reaccion_evento_3_16 "2c. Home sold property due to the recent shock  16.Loss of land"
	label var reaccion_evento_4_16 "2c. Home sent children to live with friends due to the recent shock  16.Loss of land"
	label var reaccion_evento_5_16 "2c. Home stopped sending children to school due to the recent shock  16.Loss of land"
	label var reaccion_evento_6_16 "2c. Home worked in other income generating activities due to the recent shock  16.Loss of land"
	label var reaccion_evento_8_16 "2c. Home received assistance from friends/relatives due to the recent shock  16.Loss of land"
	label var reaccion_evento_9_16 "2c. Home received loans from friends/relatives due to the recent shock  16.Loss of land"
	label var reaccion_evento_10_16 "2c. Home took loans from financial institutions due to the recent shock  16.Loss of land"
	label var reaccion_evento_12_16 "2c. Home had members who emigrated for work due to the recent shock  16.Loss of land"
	label var reaccion_evento_13_16 "2c. Home did credit purchases due to the recent shock  16.Loss of land"
	label var reaccion_evento_14_16 "2c. Home delayed payment obligations due to the recent shock  16.Loss of land"
	label var reaccion_evento_15_16 "2c. Home sold harvest in advance due to the recent shock  16.Loss of land"
	label var reaccion_evento_16_16 "2c. Home reduced the consumption of food due to the recent shock  16.Loss of land"
	label var reaccion_evento_17_16 "2c. Home reduced the consumption of non-food due to the recent shock  16.Loss of land"
	label var reaccion_evento_18_16 "2c. Home used savings due to the recent shock  16.Loss of land"
	label var reaccion_evento_19_16 "2c. Home received assistance from NGO due to the recent shock  16.Loss of land"
	label var reaccion_evento_20_16 "2c. Home took payments in advance from employer due to the recent shock  16.Loss of land"
	label var reaccion_evento_21_16 "2c. Home received assistance from the government due to the recent shock  16.Loss of land"
	label var reaccion_evento_22_16 "2c. Home was covered by an insurance due to the recent shock  16.Loss of land"
	label var reaccion_evento_23_16 "2c. Home did nothing due to the recent shock  16.Loss of land"
	label var reaccion_evento_24_16 "2c. Home did other things due to the recent shock  16.Loss of land"
	label var reaccion_evento_1_17 "2c. Home sold livestock due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_2_17 "2c. Home sold land due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_3_17 "2c. Home sold property due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_4_17 "2c. Home sent children to live with friends due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_5_17 "2c. Home stopped sending children to school due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_6_17 "2c. Home worked in other income generating activities due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_8_17 "2c. Home received assistance from friends/relatives due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_9_17 "2c. Home received loans from friends/relatives due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_10_17 "2c. Home took loans from financial institutions due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_12_17 "2c. Home had members who emigrated for work due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_13_17 "2c. Home did credit purchases due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_14_17 "2c. Home delayed payment obligations due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_15_17 "2c. Home sold harvest in advance due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_16_17 "2c. Home reduced the consumption of food due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_17_17 "2c. Home reduced the consumption of non-food due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_18_17 "2c. Home used savings due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_19_17 "2c. Home received assistance from NGO due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_20_17 "2c. Home took payments in advance from employer due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_21_17 "2c. Home received assistance from the government due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_22_17 "2c. Home was covered by an insurance due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_23_17 "2c. Home did nothing due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_24_17 "2c. Home did other things due to the recent shock  17: Death of cattle from disease"
	label var reaccion_evento_1_18 "2c. Home sold livestock due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_2_18 "2c. Home sold land due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_3_18 "2c. Home sold property due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_4_18 "2c. Home sent children to live with friends due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_5_18 "2c. Home stopped sending children to school due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_6_18 "2c. Home worked in other income generating activities due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_8_18 "2c. Home received assistance from friends/relatives due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_9_18 "2c. Home received loans from friends/relatives due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_10_18 "2c. Home took loans from financial institutions due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_12_18 "2c. Home had members who emigrated for work due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_13_18 "2c. Home did credit purchases due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_14_18 "2c. Home delayed payment obligations due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_15_18 "2c. Home sold harvest in advance due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_16_18 "2c. Home reduced the consumption of food due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_17_18 "2c. Home reduced the consumption of non-food due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_18_18 "2c. Home used savings due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_19_18 "2c. Home received assistance from NGO due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_20_18 "2c. Home took payments in advance from employer due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_21_18 "2c. Home received assistance from the government due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_22_18 "2c. Home was covered by an insurance due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_23_18 "2c. Home did nothing due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_24_18 "2c. Home did other things due to the recent shock  18.Increase in the price of supplies"
	label var reaccion_evento_1_19 "2c. Home sold livestock due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_2_19 "2c. Home sold land due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_3_19 "2c. Home sold property due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_4_19 "2c. Home sent children to live with friends due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_5_19 "2c. Home stopped sending children to school due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_6_19 "2c. Home worked in other income generating activities due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_8_19 "2c. Home received assistance from friends/relatives due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_9_19 "2c. Home received loans from friends/relatives due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_10_19 "2c. Home took loans from financial institutions due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_12_19 "2c. Home had members who emigrated for work due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_13_19 "2c. Home did credit purchases due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_14_19 "2c. Home delayed payment obligations due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_15_19 "2c. Home sold harvest in advance due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_16_19 "2c. Home reduced the consumption of food due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_17_19 "2c. Home reduced the consumption of non-food due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_18_19 "2c. Home used savings due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_19_19 "2c. Home received assistance from NGO due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_20_19 "2c. Home took payments in advance from employer due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_21_19 "2c. Home received assistance from the government due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_22_19 "2c. Home was covered by an insurance due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_23_19 "2c. Home did nothing due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_24_19 "2c. Home did other things due to the recent shock  19.Fall in the price of products"
	label var reaccion_evento_1_20 "2c. Home sold livestock due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_2_20 "2c. Home sold land due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_3_20 "2c. Home sold property due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_4_20 "2c. Home sent children to live with friends due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_5_20 "2c. Home stopped sending children to school due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_6_20 "2c. Home worked in other income generating activities due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_8_20 "2c. Home received assistance from friends/relatives due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_9_20 "2c. Home received loans from friends/relatives due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_10_20 "2c. Home took loans from financial institutions due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_12_20 "2c. Home had members who emigrated for work due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_13_20 "2c. Home did credit purchases due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_14_20 "2c. Home delayed payment obligations due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_15_20 "2c. Home sold harvest in advance due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_16_20 "2c. Home reduced the consumption of food due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_17_20 "2c. Home reduced the consumption of non-food due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_18_20 "2c. Home used savings due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_19_20 "2c. Home received assistance from NGO due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_20_20 "2c. Home took payments in advance from employer due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_21_20 "2c. Home received assistance from the government due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_22_20 "2c. Home was covered by an insurance due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_23_20 "2c. Home did nothing due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_24_20 "2c. Home did other things due to the recent shock  20.Increase in the price of the main food consumed"
	label var reaccion_evento_1_21 "2c. Home sold livestock due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_2_21 "2c. Home sold land due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_3_21 "2c. Home sold property due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_4_21 "2c. Home sent children to live with friends due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_5_21 "2c. Home stopped sending children to school due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_6_21 "2c. Home worked in other income generating activities due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_8_21 "2c. Home received assistance from friends/relatives due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_9_21 "2c. Home received loans from friends/relatives due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_10_21 "2c. Home took loans from financial institutions due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_12_21 "2c. Home had members who emigrated for work due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_13_21 "2c. Home did credit purchases due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_14_21 "2c. Home delayed payment obligations due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_15_21 "2c. Home sold harvest in advance due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_16_21 "2c. Home reduced the consumption of food due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_17_21 "2c. Home reduced the consumption of non-food due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_18_21 "2c. Home used savings due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_19_21 "2c. Home received assistance from NGO due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_20_21 "2c. Home took payments in advance from employer due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_21_21 "2c. Home received assistance from the government due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_22_21 "2c. Home was covered by an insurance due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_23_21 "2c. Home did nothing due to the recent shock  21.Kidnapping / robbery / assault"
	label var reaccion_evento_24_21 "2c. Home did other things due to the recent shock  21.Kidnapping / robbery / assault"
