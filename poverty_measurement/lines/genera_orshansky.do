...
use "$output/reference_col.dta", replace
tempfile reference
...
save "$output/expenditure_reference_col.dta", replace

// collapse by type to generate spending by type of goods
...
egen food_exp = rowtotal(gasto_mensual1 gasto_mensual6)
...
egen total_non_food_exp = total(non_food_exp)
gen olshansky_ref = total_exp/ total_food_exp  
