...
*Include phone survey
merge m:1 interview__key interview__id quest using "$dataofficial\contactos20200327.dta"

global telefono phone_listing phone_survey listing edate
rename edate edata(phone survey)
/*(************************************************************************************************************************************************* 
...
order $control_ent $telefono $det_hogares $id_ENCOVI $demo_ENCOVI $dwell_ENCOVI $dur_ENCOVI $educ_ENCOVI $health_ENCOVI $labor_ENCOVI $bank_ENCOVI $mortali_ENCOVI $emigra_ENCOVI $segalimentaria_ENCOVI $shocks_ENCOVI $antropo_ENCOVI ///
...
keep $control_ent $telefono $det_hogares $id_ENCOVI $demo_ENCOVI $dwell_ENCOVI $dur_ENCOVI $educ_ENCOVI $health_ENCOVI $labor_ENCOVI $bank_ENCOVI $mortali_ENCOVI $emigra_ENCOVI $segalimentaria_ENCOVI $shocks_ENCOVI $antropo_ENCOVI ///
...
save "$pathout\ENCOVI_2019(telefonos).dta", replace
