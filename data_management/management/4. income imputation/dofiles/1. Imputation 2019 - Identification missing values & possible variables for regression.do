...
*** 1. Those who report receiving but then don't report amount ***
	...
	* 1.b. NON-MONETARY LABOR INCOME
		...
		* Ingreso laboral no monetario: todo analizado para el último mes (más fácil)
			...
			replace recibe_ingresolab_nomon = 0 if (inm_comida==0 & inm_productos==0 & inm_transporte==0 & inm_vehiculo==0 & inm_estaciona==0 & inm_telefono==0 & inm_servicios==0 & inm_guarderia==0 & inm_otro==0) /*para empleados*/ ///
			| inm_patron==0 /*para patrones*/ 	// No recibió ingreso laboral no monetario en ningún concepto
...
display "`varlist38'"
		...
		global dummy_vars p_agegroup_sinmis1 p_agegroup_sinmis2 p_agegroup_sinmis3 p_agegroup_sinmis4 p_agegroup_sinmis5 p_agegroup_sinmis6 p_agegroup_sinmis7 ///
