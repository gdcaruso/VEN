...
gen gasto_bol = gasto*`tc1mes2'*`deflactor2' if moneda == 1 & month == 2
...
replace gasto_bol = gasto*`tc1mes3'*`deflactor3' if moneda == 1 & month == 3
...
replace gasto_bol = gasto*`tc1mes1'*`deflactor1' if moneda == 1 & month == 1
...
replace gasto_bol = gasto*`tc1mes11'*`deflactor11' if moneda == 1 & month == 11
...
replace gasto_bol = gasto*`tc1mes12'*`deflactor12' if moneda == 1 & month == 12
...
export excel "$cleaned\preciosimplicitos_inflacorregida.xlsx",  firstrow(variables) replace)
restore
