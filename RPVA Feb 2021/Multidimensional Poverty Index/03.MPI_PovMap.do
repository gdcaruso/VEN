...
local var multi_poor //define variables of interest for fh estimation
foreach x in `var'{
...
*Check
sum multi_poor_munid,d //Check
tab multi_poor_munid, m //269 are missing
tab multi_poor_var_munid, m //269 are missing 
sum multi_poor_var_munid,d //Check
...
save "${dataout}/survey_hhlevel_fhmodel_multipoor.dta", replace
