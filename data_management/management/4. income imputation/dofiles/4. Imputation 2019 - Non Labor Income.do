...
********************************************************************************
		...
		* User 4: Malena
		...
		if $juli {
				...
				global pathoutexceloutexcel "C:\Users\wb563583\Github\VEN\data_management\management\4. income imputation\output"
		}
	    if $lauta {
...
putexcel set "$pathoutexcel\VEN_income_imputation_2019_JL.xlsx", sheet("labor_beneimp_stochastic_reg") modify
