...
g newminwage1 = 164.9 //Extreme poverty-level wage
...
gen expwage=newminwage if wagelownew==1 & (region==1 | region==3 |region==7) // if potentally affected then expected wage = new min wage
