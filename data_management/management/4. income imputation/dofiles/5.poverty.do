...
clonevar income0=income_off0
egen income1= rowtotal (linc pension2 nlinc_otro)
egen income2=rowtotal(linc_imp1 pension2 nlinc_otro) 
egen income3=rowtotal(linc_imp1 pension_imp1 nlinc_otro_imp1) 
