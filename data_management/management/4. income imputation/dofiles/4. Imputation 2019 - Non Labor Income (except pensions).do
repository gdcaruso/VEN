...
* Identifying missing values in potential independent variables for Mincer equation
	*Note: "mdesc" displays the number and proportion of missing values for each variable in varlist.
	...
	global xvar1  edad edad2 hombre npers_viv miembros /*total_hrtr_sinmis*/ ///
		p_agegroup_sinmis1 p_agegroup_sinmis2 p_agegroup_sinmis3 p_agegroup_sinmis4 p_agegroup_sinmis5 p_agegroup_sinmis6 p_agegroup_sinmis7 ///
		...
		p_propieta_hh_sinmis1 p_propieta_hh_sinmis2 ///
...
///*** EQUATION ***///
	...
	*set seed 66778899
	...
	mi impute regress log_inlanojub $lassoregress if log_inlanojub>0 & inlist(recibe_ingresonolab,1,2,3) , add($numberofimpruns) rseed(66778899) force noi 
