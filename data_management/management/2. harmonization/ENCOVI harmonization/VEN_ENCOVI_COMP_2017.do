...
gen      aporta_pension_mejorada = 0 if (relab>=1 & relab<=4) & (aporte_pension!=. | (tmhp47ss!=98 & tmhp47ss!=99 & tmhp47ss!=. & tmhp47ss!=.a) )
replace      aporta_pension_mejorada = 1 if (relab>=1 & relab<=4) & aporta_pension==1
replace      aporta_pension_mejorada = 1 if (relab>=1 & relab<=4) & tmhp47ss==1

gen aporta_pension_priv = (aporte_pension>=2 & aporte_pension<=4) if (relab>=1 & relab<=4) & aporte_pension!=.

*tmhp47pr = prestaciones sociales 
*tmhp47ss = seguro social obligatorio
*tmhp47sp = seguro privado
*tmhp47ca = caja de ahorros
*tmhp47fh = fondo de ahorro habitacional
*tmhp47sf = seguro de paro forzoso
gen proxy_formal = 0 if (relab>=1 & relab<=4)
replace proxy_formal = 1 if (aporte_pension>=1 & aporte_pension<=4) | tmhp47pr==1 | tmhp47ss==1 | tmhp47sp==1 | tmhp47ca==1 | tmhp47fh==1 | tmhp47sf==1
