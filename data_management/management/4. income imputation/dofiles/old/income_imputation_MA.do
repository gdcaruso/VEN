...
Project:	
---------------------------------------------------------------------------
Authors:			Trinidad Saavedra, Malena Acuña
...
********************************************************************************
		...
		* User 4: Malena
		...
		if $male   {
				...
				global dataout "$rootpath\ENCOVI 2014 - 2018\Projects\SEDLAC Harmonization\bases"
				global aux_do "$rootpath\ENCOVI 2014 - 2018\Projects\SEDLAC Harmonization\dofiles\aux_do"
				global data2019 "C:\Users\wb550905\Github\VEN\data_management\output\cleaned"
		}
...
gen aux=(tmhp34==1 | tmhp34==2 | (tmhp34==99 & tmhp42bs!=99 & tmhp42bs!=0) | (tmhp34==5 & tmhp42bs!=98 & tmhp42bs!=0)) // Working: occupied, or doesn't answer if occupied but earns labor income, or works in household chorus and earns labor income
gen dlinc=(aux==1 & tmhp42==1) //dummy working and receiving income
*replace dlinc=1 if tmhp42==98 & tmhp42bs!=98 & tmhp42bs!=99	
replace dlinc=1 if tmhp42==99 & tmhp42bs!=98 & tmhp42bs!=99 & tmhp42bs!=0 // person doesn't answer if received income, but then reports income amount
replace dlinc=. if tmhp42==99 & (tmhp42bs==98 | tmhp42bs==99 | tmhp42bs==0) & aux==1 // person doesn't answer if received income, doesn't report any income amount, and working
