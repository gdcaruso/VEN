...
///*** CHECKING WHICH VARIABLES MAXIMIZE R2 ***///
	...
	** LASSO
		...
		*Selected on April 20
		/*
		global lassovars hombre total_hrtr_sinmis p_agegroup_sinmis1 p_relacion_comp_sinmis3 p_estado_civil_sinmis1 p_region_est1_sinmis3 p_region_est1_sinmis5 p_municipio_sinmis1 p_municipio_sinmis6 ///
		p_municipio_sinmis8 p_municipio_sinmis16 p_municipio_sinmis17 p_propieta_hh_sinmis1 p_auto_hh_sinmis1 p_computadora_hh_sinmis2 p_calentador_hh_sinmis2 p_aire_hh_sinmis2 ///
		p_microondas_hh_sinmis2 p_tarea_sinmis4 p_tarea_sinmis6 p_tarea_sinmis8 p_sector_encuesta_sinmis1 p_sector_encuesta_sinmis3 p_sector_encuesta_sinmis6 p_categ_ocu_sinmis1 p_cuenta_corr_sinmis1 p_clap_sinmis1 p_comida_trueque_sinmis1
		*/
