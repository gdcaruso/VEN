...
label var	relacion_en 	"Relationship with head of household (ENCOVI)"
...
label def 	mes_naci 		1 "Enero" 2 "Febrero" 3 "Marzo" 4 "Abril" 5 "Mayo" 6 "Junio" 7 "Julio" 8 "Agosto" 9 "Septiembre" 10 "Octubre" 11 "Noviembre" 12 "Diciembre"
label var	dia_naci 		"Day of birth"
label var	pais_naci 		"Country of birth"
/*def var 	pais_naci		1 "Venezuela" 2 "Colombia" 3 "Ecuador" 4 "Peru" 5 "Chile" 6 "Argentina" 7 "Brasil" 8 "Guyana" ///
...
label var    pipcf	         "Percentiles household per capita income"
label var    dipcf	         "Income deciles per capita household income"
label var    p_ing_ofi	     "Income percentiles to estimate official poverty"
label var    d_ing_ofi	     "Income deciles to estimate official poverty"
label var    piea	     	 "Percentiles equivalized income A"
label var    qiea	         "Quintiles equivalized income A"
label var    pondera_i	     "Weight for income variables"  
label var    ipc05	         "Average Consumer Price Index for 2005"
label var    ipc11	     	 "Average Consumer Price Index for 2011"
label var    ppp05	   	 	 "PPP conversion factor (2005)"
label var    ppp11	         "PPP conversion factor (2011)"
label var    ipcf_cpi05	     "Per capita household income (2005 values)"
label var    ipcf_cpi11	     "Per capita household income (2011 values)"
label var    ipcf_ppp05	     "Per capita household income (2005 dollars)"
label var    ipcf_ppp11	     "Per capita household income (2011 dollars)"
